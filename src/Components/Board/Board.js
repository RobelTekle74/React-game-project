...
//                 <button onClick={this.difficultySelectHandler}>Easy</button>
//                 <button onClick={this.difficultySelectHandler}>Medium</button>
//                 <button onClick={this.difficultySelectHandler}>Hard</button>
//             </div>
//         )
//     }
// }