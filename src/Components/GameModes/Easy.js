          ...
          <table id="board">
              <tbody className="tableBody">
                ...
                <tr>
                  ...
                  <td id="r1c6" ><input type="text" maxLength="1">4</input> </td>
                ...
                <tr>
                  ...
                  <td id="r2c1" ><input type="text" maxLength="1">1</input> </td>
                  ...
                  <td id="r2c6" ><input type="text" maxLength="1">6</input> </td>
                  <td id="r2c7" ><input type="text" maxLength="1">5</input> </td>
                  <td id="r2c8" ><input type="text" maxLength="1"></input> </td>
                </tr>
                <tr>
                  <td id="r3c0" ><input type="text" maxLength="1">5</input> </td>
                  <td id="r3c1" ><input type="text" maxLength="1"></input> </td>
                  <td id="r3c2" ><input type="text" maxLength="1">9</input> </td>
                  <td id="r3c3" ><input type="text" maxLength="1"></input> </td>
                  <td id="r3c4" ><input type="text" maxLength="1">3</input> </td>
                  <td id="r3c5" ><input type="text" maxLength="1"></input> </td>
                  <td id="r3c6" ><input type="text" maxLength="1">7</input> </td>
                  <td id="r3c7" ><input type="text" maxLength="1">8</input> </td>
                ...
                <tr>
                  ...
                  <td id="r4c4" ><input type="text" maxLength="1">7</input> </td>
                ...
                <tr>
                  ...
                  <td id="r5c1" ><input type="text" maxLength="1">4</input> </td>
                  <td id="r5c2" ><input type="text" maxLength="1">8</input> </td>
                  <td id="r5c3" ><input type="text" maxLength="1"></input> </td>
                  <td id="r5c4" ><input type="text" maxLength="1">2</input> </td>
                  <td id="r5c5" ><input type="text" maxLength="1"></input> </td>
                  <td id="r5c6" ><input type="text" maxLength="1">1</input> </td>
                  <td id="r5c7" ><input type="text" maxLength="1"></input> </td>
                  <td id="r5c8" ><input type="text" maxLength="1">3</input> </td>
                </tr>
                <tr>
                  <td id="r6c0" ><input type="text" maxLength="1"></input> </td>
                  <td id="r6c1" ><input type="text" maxLength="1">5</input> </td>
                  <td id="r6c2" ><input type="text" maxLength="1">2</input> </td>
                  ...
                  <td id="r6c7" ><input type="text" maxLength="1">9</input> </td>
                ...
                <tr>
                  ...
                  <td id="r7c2" ><input type="text" maxLength="1">1</input> </td>
